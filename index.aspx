...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<div class="container-fluid">
			<div class="row main-top-w3l py-2">
				<div class="col-lg-4 header-most-top">
					<p class="text-white text-lg-left text-center">Bölgenin En İyisi
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					<!-- header lists -->
					<ul>
					<!--<li class="text-center border-right text-white"> <a class="play-icon popup-with-zoom-anim text-white" href="#small-dialog1"> <i class="fas fa-map-marker mr-2"></i>Select Location</a></li>-->
						<li class="text-center border-right text-white">
							<a href="#" data-toggle="modal" data-target="#exampleModal" class="text-white">
								<i class="fas fa-truck mr-2"></i>Track Order</a>
						</li>
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> +90 (538) 576 0983
						</li>
						<li class="text-center border-right text-white">
							<a href="#" data-toggle="modal" data-target="#exampleModal" class="text-white">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title text-center">Giriş</h5>
				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<div class="right-w3l">
							<input type="submit" class="form-control" value="Giriş Yap">
						</div>
						<div class="sub-w3l">
						...
						<p class="text-center dont-do mt-3">Hesabınız mı yok ?
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<div class="form-group">
							<label class="col-form-label">Parolayı Doğrula</label>
						...
						<div class="sub-w3l">
							<div class="custom-control custom-checkbox mr-sm-2">
								...
								<label class="custom-control-label" for="customControlAutosizing2">Sitemizdeki haberlerden beni haberdar et</label>
							</div>
						</div>
					</form>
				</div>
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.aspx" class="font-weight-bold font-italic">
							<img src="images/logo2.png" alt=" " class="img-fluid">Electro Market
						</a>
					</h1>
				</div>
				<!-- //logo -->
					...
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="#" method="post">
								<input class="form-control mr-sm-2" type="search" placeholder="Ara" aria-label="Search" required>
		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5" runat="server" id="anamenu">								
					</ul>
				</div>
			</nav>
		</div>
	...
	<div class="join-w3l1 py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<div class="row">
				<div class="col-lg-6">
                    <!-- anket -->
                    <form id="anketform" runat="server">
					 <div class="join-agile text-left p-4">          
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
						 <ContentTemplate>
                          <div class="row">
							<div class="col-sm-6 offer-name">
								<div id="anketsorusu" style="font-weight:bold; text-align:center; margin-left:15px; margin-top:-60px !important;" class="row" runat="server"></div>
                                <div class="row cevaplar" style="font-weight:400;text-align:justify; padding-bottom:15px;">
                                    <asp:RadioButtonList ID="rbtnlanketcevaplari" runat="server"></asp:RadioButtonList>  
                                </div>
                                <div class="row">
                                    <asp:Button ID="btncevapgonder"  runat="server" Text="Cevap Gönder" CssClass="btn btn-dark" OnClick="btncevapgonder_Click"/>
                                </div>
							</div>
							<div class="col-sm-6 offerimg-w3l">
                                <asp:RequiredFieldValidator ID="rfvanketcevaplari" runat="server" ErrorMessage="Lütfen bir cevap seçiniz !!" CssClass="alert alert-danger islemtamam mt-4" ControlToValidate="rbtnlanketcevaplari"></asp:RequiredFieldValidator>
                               <asp:Label ID="lblislemtamam" runat="server" Text="Teşekkürler cevabınız alındı" CssClass="alert alert-success islemtamam" Font-Size="14px" Visible="false"></asp:Label>
					...
					<div class="join-agile text-left p-4">
						<div class="row ">
							<div class="col-sm-7 offer-name">								
								<h4 class="mt-4 mb-3" style="margin-top:-55px !important; padding-bottom:35px !important;">Anket Sonuçları İçin</h4>
							</div>
							<div class="col-sm-5 offerimg-w3l">
								<a href="#" class="btn btn-light" style="margin-top:55px; margin-bottom:40px;">Tıklayınız</a>
							</div>
						</div>
                      <!-- anket bitti -->
					</div>
				...
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids w3l-agileits mt-md-0 mt-4">
						...
						<div class="footer-grids  w3l-socialmk mt-3">
							...
							<div class="social">
								<ul id="sosyalsitebaglantilarialt" runat="server">
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© Telif Hakları Gizlidir | Design by
				<a href="index.aspx"> @enesagalar</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
